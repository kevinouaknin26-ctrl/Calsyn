      ...
      <div className="fixed inset-0 bg-black/15 flex items-start justify-center pt-[5vh] z-40"
        ...
        <div className="bg-white rounded-2xl shadow-xl w-[880px] max-h-[85vh] flex overflow-hidden animate-fade-in-scale">
          ...
          <div className="w-[300px] p-5 border-r border-gray-100 flex flex-col overflow-y-auto">
            ...
            {/* 4 icones (Minari : LinkedIn, clipboard, globe, plus) */}
            <div className="flex gap-1.5 ml-9 mb-3">
              <div className={`w-6 h-6 rounded-lg flex items-center justify-center text-[9px] font-bold border ${prospect.linkedin_url ? 'bg-blue-50 text-blue-500 border-blue-200' : 'bg-gray-50 text-gray-300 border-gray-200'} cursor-pointer`}>in</div>
              <div className="w-6 h-6 rounded-lg flex items-center justify-center bg-gray-50 text-gray-400 border border-gray-200 cursor-pointer">
              ...
              <div className="w-6 h-6 rounded-lg flex items-center justify-center bg-gray-50 text-gray-400 border border-gray-200 cursor-pointer">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9" /></svg>
              </div>
              <div className="w-6 h-6 rounded-lg flex items-center justify-center bg-gray-50 text-gray-400 border border-gray-200 cursor-pointer">
            ...
            {/* Bouton Call (Minari teal pill + dropdown + camera + outils) */}
            {!callsDisabled && (
              <div className="flex items-center gap-2 mb-4">
                {isInCall ? (
                  <div className="flex-1 py-2.5 rounded-xl text-[13px] font-medium bg-gray-100 text-gray-400 flex items-center justify-center gap-2 border border-gray-200">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    Appel en cours
                  ...
                  <button onClick={() => onCall(prospect)} disabled={!providerReady}
                    className="flex-1 py-2.5 rounded-xl text-[13px] font-semibold bg-teal-600 text-white hover:bg-teal-700 disabled:opacity-40 flex items-center justify-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
